        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
            <Card className="lg:col-span-1">
                ...
                <div className="space-y-4">
                    <Select label="Nível na Carreira" id="posicaoCarreira" value={parametrosGlobaisAtuais.posicaoCarreira} onChange={(e) => {
                    ...
                    <Input label="Ano de Ingresso" id="anoIngresso" type="number" min="0" value={parametrosGlobaisAtuais.anoIngresso} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, anoIngresso: parseInt(e.target.value) || 0 }))} />
                    <Input label="Valor do Ponto GEPI (R$)" id="valorPontoGEPI" type="number" step="0.01" value={parametrosGlobaisAtuais.valorPontoGEPI} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, valorPontoGEPI: parseFloat(e.target.value) || 0 }))} />
                    <Input label="Reajuste Geral Anual Médio (%)" id="RGAMedio" type="number" value={parametrosGlobaisAtuais.RGAMedio} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, RGAMedio: parseFloat(e.target.value) || 0 }))} />
                    <Input label="Crescimento da GEPI Médio (%)" id="crescimentoGEPIMedio" type="number" value={parametrosGlobaisAtuais.crescimentoGEPIMedio} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, crescimentoGEPIMedio: parseFloat(e.target.value) || 0 }))} />
                    <Input label="Teto da GEPI (× VB II-J)" id="tetoGEPI" type="number" value={parametrosGlobaisAtuais.tetoGEPI} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, tetoGEPI: parseFloat(e.target.value) || 0 }))} />
                    <Input label="Teto do Servidor Público" id="tetoServidorPublico" type="number" value={parametrosGlobaisAtuais.tetoServidorPublico} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, tetoServidorPublico: parseFloat(e.target.value) || 0 }))} />
                    <Input label="Dependentes de IR" id="dependentes" type="number" min="0" value={parametrosGlobaisAtuais.dependentes} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, dependentes: parseInt(e.target.value) || 0 }))} />
                    <Input label="Dias Trabalhados (Ajuda de Custo)" id="diasTrabalhados" type="number" min="0" value={parametrosGlobaisAtuais.diasTrabalhados} onChange={(e) => defineParametrosGlobaisAtuais(p => ({ ...p, diasTrabalhados: parseInt(e.target.value) || 0 }))} />
