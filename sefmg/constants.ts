...
export const VENCIMENTO_BASICO = {
  data: [
    { nivel: 'I', grau: 'A', vb: 6297.87 },
    { nivel: 'I', grau: 'B', vb: 6486.82 },
    { nivel: 'I', grau: 'C', vb: 6681.42 },
    { nivel: 'I', grau: 'D', vb: 6881.86 },
    { nivel: 'I', grau: 'E', vb: 7088.33 },
    { nivel: 'I', grau: 'F', vb: 7300.96 },
    { nivel: 'I', grau: 'G', vb: 7519.99 },
    { nivel: 'I', grau: 'H', vb: 7745.59 },
    { nivel: 'I', grau: 'I', vb: 7977.97 },
    { nivel: 'I', grau: 'J', vb: 8217.30 },
    { nivel: 'II', grau: 'A', vb: 7872.36 },
    { nivel: 'II', grau: 'B', vb: 8187.24 },
    { nivel: 'II', grau: 'C', vb: 8514.72 },
    { nivel: 'II', grau: 'D', vb: 8855.32 },
    { nivel: 'II', grau: 'E', vb: 9209.54 },
    { nivel: 'II', grau: 'F', vb: 9577.91 },
    { nivel: 'II', grau: 'G', vb: 9961.03 },
    { nivel: 'II', grau: 'H', vb: 10359.47 },
    { nivel: 'II', grau: 'I', vb: 10773.86 },
    { nivel: 'II', grau: 'J', vb: 11204.81 }
  ],
