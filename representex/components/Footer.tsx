...
const InstagramIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <path d="M12 6.865c-2.841 0-5.135 2.294-5.135 5.135s2.294 5.135 5.135 5.135 5.135-2.294 5.135-5.135-2.294-5.135-5.135-5.135zm0 8.27c-1.732 0-3.135-1.403-3.135-3.135s1.403-3.135 3.135-3.135 3.135 1.403 3.135 3.135-1.403 3.135-3.135 3.135zm4.905-6.87c-.63 0-1.14.51-1.14 1.14s.51 1.14 1.14 1.14 1.14-.51 1.14-1.14-.51-1.14-1.14-1.14z"></path>
    </svg>
);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            ...
            <p className="text-gray-400">Desde 1987, trazendo saúde e praticidade para sua vida.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition duration-300">
                <InstagramIcon />
              </a>
            </div>
          </div>
